...
```bash
python3 analyze_flight.py --logdir csv/log_41_2026-1-8-22-52-32 --out analysis_out/log_41_2026-1-8-22-52-32_v2 --plots --report
```
...
| vehicle_attitude | log_41_2026-1-8-22-52-32_vehicle_attitude_0.csv | timestamp | timestamp_sample, q[0], q[1], q[2], q[3], delta_q_reset[0], delta_q_reset[1], delta_q_reset[2], delta_q_reset[3], quat_reset_counter |
...
| vehicle_local_position | log_41_2026-1-8-22-52-32_vehicle_local_position_0.csv | timestamp | timestamp_sample, ref_timestamp, ref_lat, ref_lon, x, y, z, delta_xy[0], delta_xy[1], delta_z, vx, vy, vz, z_deriv, delta_vxy[0], delta_vxy[1], delta_vz, ax, ay, az |
...
| vehicle_air_data | log_41_2026-1-8-22-52-32_vehicle_air_data_0.csv | timestamp | timestamp_sample, baro_device_id, baro_alt_meter, baro_pressure_pa, ambient_temperature, rho, temperature_source, calibration_count |
...
- nav_state_transitions:
  - t=21.517s: {'nav_state': 15}
- arming_state_transitions:
  - t=85.443s: {'arming_state': 1}
...
| freq_vs_manual_roll | -0.0065 | 657 |
| freq_vs_output[0] | 0.8008 | 1302 |
| freq_vs_output[1] | 0.0684 | 1302 |
| freq_vs_output[2] | 0.9973 | 1302 |
| freq_vs_output[3] | nan | 1302 |
